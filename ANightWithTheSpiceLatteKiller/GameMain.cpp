...
GameMain::GameMain() {
	...
	KillerMainRef = new KillerMain(MapManagerRef, DialoguePrinterRef, GameSessionRef, SoundManagerRef);
	PlayerMainRef = new PlayerMain(MapManagerRef, KillerMainRef, SoundManagerRef, DialoguePrinterRef, GameSessionRef);
